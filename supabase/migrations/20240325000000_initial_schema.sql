...
-- Create profiles table (depends on subscription_plans)
...
-- Create investigations table (depends on profiles)
...
-- Create node table (depends on profiles and investigations)
...
-- Create reports table (depends on investigations)
