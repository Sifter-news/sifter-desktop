...
drop policy "Enable delete for authenticated users" on "public"."connections";

drop policy "Enable insert for authenticated users" on "public"."connections";

drop policy "Enable read access for all users" on "public"."connections";

drop policy "Enable update for authenticated users" on "public"."connections";
...
alter table "public"."connections" drop constraint "connections_source_id_fkey";

alter table "public"."connections" drop constraint "connections_target_id_fkey";
...
drop index if exists "public"."connections_source_id_idx";

drop index if exists "public"."connections_target_id_idx";
...
alter table "public"."node" drop column "order_index";

alter table "public"."node" drop column "parent_id";

alter table "public"."node" drop column "text_align";

alter table "public"."node" drop column "text_size";

alter table "public"."node" add column "parent_node_id" uuid;
...
alter table "public"."profiles" add column "subscription_end_date" timestamp without time zone;

alter table "public"."profiles" add column "subscription_start_date" timestamp without time zone;
...
alter table "public"."node" add constraint "node_parent_node_id_fkey" FOREIGN KEY (parent_node_id) REFERENCES node(id) ON DELETE SET NULL not valid;

alter table "public"."node" validate constraint "node_parent_node_id_fkey";
