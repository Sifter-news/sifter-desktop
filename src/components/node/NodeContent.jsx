          ...
          <div className={cn("p-4 shadow-md", baseClasses)}>
            ...
            {isFocused ? (
              <Textarea
                ...
                onBlur={handleInputBlur}
                className="bg-transparent border-none resize-none text-sm h-[calc(100%-40px)] focus:ring-0 focus:outline-none focus:border-none focus:shadow-none selection:bg-transparent"
          ...
          <div className={cn("p-3", baseClasses)}>
            ...
            {isFocused ? (
              <Textarea
                ...
                onChange={(e) => setLocalDescription(e.target.value)}
                onBlur={handleInputBlur}
                className="bg-transparent border-none resize-none mt-2 focus:ring-0 focus:outline-none focus:border-none focus:shadow-none selection:bg-transparent"
              />
            ) : (
              <div className="text-sm text-gray-600 mt-2">{node.description}</div>
            )}
