...
const InvestigationCard = ({ investigation }) => {
  return (
    <Link to={`/project/${investigation.id}`} className="block w-full lg:w-[548px]">
      <Card className="h-[323px] p-6 bg-[#594BFF] shadow-lg relative overflow-hidden rounded-l-[48px] rounded-r-none lg:rounded-r-none">
        <div 
